...
|------|----------|------------------------|
|<td style="background-color: #ffcccc;">&nbsp;&nbsp;&nbsp;  **k** </td>| kohalolek klassis | присутствие на занятии |
...
Применение ручной заливки ячеек с помощью инструмента **«Цвет заливки»** не предусмотрено функционалом электронного журнала.  

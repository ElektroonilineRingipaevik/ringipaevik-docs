# ✅ Klass  {#klass}   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   [⬅️ на главную](../README.md)   <button onclick="window.location.href='../index.html'" style="transform: scale(0.6); transform-origin: left center; margin-left: 4em;">
    <img vertical-align="middle" width="22" height="22" src="https://img.icons8.com/office/40/arrow-pointing-left.png" alt="thick-arrow-pointing-up"/> На главную&nbsp;</button>
...
$\color{#008000}{\textsf{\LARGE{♺} \normalsize{}}}$ *Если пользователь применит ручную заливку в диапазоне посещаемости, система автоматически выполнит сброс данного форматирования в течение определённого времени, установленного администратором. Факт выполнения автоматической очистки фиксируется в журнале действий пользователя.*
